...
const cartSlice = createSlice({
    ...
    reducers: {
        ...
        removeItem: (state, action) => {
            const removeItem = state.itemList.filter((item) => item.id !== action.payload);
...
export const { addToCart, incrementQuantity, decrementQuantity, removeItem, setField, editCellValue, clearCart } = cartSlice.actions;
